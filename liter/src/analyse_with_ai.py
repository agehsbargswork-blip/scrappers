...
- Каждую возможность в open_call и awards записывай с новой строки строго в формате:
  «Название — дедлайн или “не указан” — короткое описание сути: что принимают или
  для кого предназначена возможность — прямой официальный URL».
